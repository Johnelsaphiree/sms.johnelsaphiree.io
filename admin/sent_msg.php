...
$sel = new select();
	$sel->pick('smslog', '*', '', '', '', 'record', '', '', '', '');
$xsel = new select();
	$xsel->pick('smslog', 'id, senderid, message, credit, unix_timestamp(date)', '', '', "$start, $records", 'record', 'id desc', '', '', '');
...
<html lang="en">
  ...
  {
	  ?>
      <li><a href="sent_msg.php">SENT MESSAGES</a></li>
